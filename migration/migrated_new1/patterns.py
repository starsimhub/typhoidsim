...
"""
Classes that support the introduction of 'pre-defined'
...
class Pattern:
    ...
    **Examples**::
    ...
    def __repr__(self):
        ...
        string = f"ss.{classname}({tracestr}, {pttrnstr}pars={dict(self.pars)})"
        return string
    ...
    def generate_data(self, vmin=0, vmax=128, step=None):
        ...
        """
        if step is None:
            step = float(vmax - vmin) / ss.options.default_plot_granularity
