...
class Typhoid(ss.Disease):
    ...
    def validate_beta(self):
        ...
        if networks is not None and len(networks) > 0:
            ...
            if self.pars.beta is None:
                ...
                self.pars.beta = 1. / self.sim.t.dt
    ...
    def prepare_partial_prep_funs(self):
        ...
        the distribution of prepatent durations.
        """
    ...
    def make_susceptible(self):
        ...
        self.ti_susceptible[never_exposed] = self.sim.t.ti  # Save the timing people became susceptible
        return
    ...
    def step_state(self):
        ...
        ti = self.sim.t.ti  # current timestep
    ...
    def get_subclinical_duration_by_age(self, uids):
        """
        Determine duration of the subclinical stage
        """
        p = self.pars
        dt = self.sim.t.dt
    ...
    def set_prognoses(self, uids, source_uids=None):
        ...
        as parameters of the model to determine whol will become acute/sublincal/chronic, etc.
        ...
        # progress to the next state (either acute or sublclinical)
    ...
    def make_new_cases_contact(self):
        ...
        for i, (nkey, net) in enumerate(self.sim.networks.items()):
            ...
            for src, trg, beta in [p1p2b0]:
                ...
                # beta_per_dt = net.beta_per_dt(disease_beta=beta, dt=self.sim.t.dt)  # This is equal to 1, but needs to be here for starsim networks
