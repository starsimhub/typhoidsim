...
These classes are derived from starsim's Analyzers because they need
...
class HistogramsByAgeSexMonitor(Monitor):
    ...
    def plot_waterfall(self, key=None, max_timepoints=16, fig=None, style='fancy', fig_kw=None, plot_kw=None):
        ...
        a given metric (i.e., number of new acute cases) with respect to age.
        ...
        min-max age specified, for a specific time step (i.e., there are no agents in that age group), it adds a
