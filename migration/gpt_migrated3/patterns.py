    ...
    **Examples**::
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(name=name, label=pattern_name)
...
class StateVariable(ss.Result):
    ...
    def __new__(cls, module=None, name=None, shape=None, dtype=None, scale=None, label=None):
        return super().__new__(cls, module=module, name=name, shape=shape, dtype=dtype, scale=scale, label=label)
