...
class Births(ss.Demographics):
    ...
    def standardize_birth_data(self):
        ...
        if isinstance(birth_rate, (pd.Series, pd.DataFrame)):
            birth_rate = birth_rate.xs(0, level='age')  # Assume age-independent birth rates
        return birth_rate
    ...
    def init_pre(self, sim):
        ...
        if isinstance(self.pars.birth_rate, pd.DataFrame):
            ...
            all_birth_rates = np.interp(sim.t.yearvec, br_year, br_val)
    ...
    def get_births(self):
        ...
        # Calculate scaled birth probability
    ...
    def step(self):
        """ Perform the step operation for births """
    ...
    def update_results(self):
        """ Update results with new births and crude birth rate """
