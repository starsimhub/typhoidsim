...
class Typhoid(ss.Disease):
    ...
    def init_post(self):
        ...
        self.progress_to_prepatent(self.ti)   # Set the correct level of infectiousness of initial cases
        return
    ...
    def make_new_cases_contact(self):
        ...
        if len(new_cases):
            ...
            self.progress_to_prepatent(self.ti)
