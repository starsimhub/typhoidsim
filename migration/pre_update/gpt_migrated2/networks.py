...
class CommunityNet(ss.DynamicNetwork):
    ...
    def __init__(self, pars=None, key_dict=None, **kwargs):
        ...
        self.define_states(
            ss.IndexArr('age_group', default=0, label='Age group')
        )
    ...
    def get_contact_rates(self):
        """
        Get average number of total contacts per day, per age group
    ...
    def get_edges(self, born, n_contacts):
    ...
    def add_pairs(self):
        ...
        p1, p2 = self.get_edges(born, n_contacts)
...
class HouseholdNet(ss.DynamicNetwork):
    ...
    def get_edges(self, inds, n_contacts):
        ...
        adjusted_number_of_contacts = np.round(number_of_contacts / 2).astype(ss.dtypes.int)
    ...
    def make_households(self):
       ...
       # we need to generate_household_head_by_size_distribution() based on current distribution
    ...
    def get_households(self):
        ...
        Returns:
            An array with the count of households of size 's' at initialization.
        """
        ...
        while n_agents_diff != 0:
            ...
            n_agents_diff, n_households_by_size = self.adjust_households(n_agents_diff,
...
def generate_household_head_by_size_distribution(nhh_by_hs, hh_head_age_dist):
    ...
    Returns: DataFrame of household head by size distribution.
    """
    import pandas as pd
    ...
    # Counts of unique combinations of household heads of a given age and household size
