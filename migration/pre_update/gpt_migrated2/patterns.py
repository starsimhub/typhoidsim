...
class Pattern:
    ...
    variable like age or time, or 'agent-space'. Inspired by starsim's Distribution class
    can be expanded in functionality.

    Args:
        equation (str): required; a simple string that defines the pattern
    ...
    **Examples**::
    ...
    def evaluate(self, var):
        ...
        The argument ``var`` can represent time, or age. It can be a
...
class StateVariable(ss.BaseArr):
    """
    This class is similar to Results but is named to something more generic,
    ...
    This is a structure that holds an internal state of our system (i.e., module)
