...
Welcome! We are thrilled you are interested in contributing to Typhoidsim,
part of the Starsim suite. This document will help you get started.

- We are serious about inclusion and believe the open-source software
community still has a long way to go. The Starsim community follows a
`code of conduct`_. By participating in the Typhoid project, you agree to abide by
its terms.
- Take a look at our house `style guide`_. Typhoidsim more or less follows
Google's Python style guide, but with some exceptions.
...
.. _open an issue: https://github.com/starsimhub/typhoidsim/issues/new/choose