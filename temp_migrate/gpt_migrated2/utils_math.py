...
def double_sigmoid_tanh(x, l1, l2, l3, x_12, x_23, s=1.0):
    ...
    Example:
        ...
        >>> double_sigmoid_tanh(x, 2.235, 2.002, 1.5487, 5_050_000, 55_000_000, 1)
    """
...
def asym_trapezoidal(x, period=365.0, peak_start_doy=45.0, ramp_up_dur=15.0,
    ...
    Args:
        ...
        ramp_dw_dur (float): Duration, in days, of the period over which the environmental exposure route decreases seasonally.
