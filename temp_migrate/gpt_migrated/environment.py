...
class EnvironmentalPool(ss.Module):
    def __init__(self, pars=None, metadata=None, **kwargs):
        super().__init__(name='Environmental Pool')
        self.define_pars(
            init_cfu=0,            # Initial level of CFUs in the environment.
            decay_rate=0.3,        # Decay rate of environmental in fraction of CFUs that decay in 1/day
            ...
            transmission=ss.Pars(
                ...
                env2ppl_exposure_rate=ss.poisson(lam=2.0),  # Poisson rate for environmental exposures
            ),
        )
