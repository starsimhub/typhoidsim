...
so they can be consumed by typhoidsim or starsim.
"""
...
def get_household_head_age_by_size_distribution(location):
    """
    Calculate the contingency table, representing the probabilities of each
