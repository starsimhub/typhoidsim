...
class Gallstones(ss.NCD):
    """
    Non-communicable disease (NCD). A basic model that
    implements the risk of having gallstones based on age and gender.
    The presence of gallstones increases the risk of becoming a chronic
    carrier of Typhoidsim.
    """
    ...
    def init_vals(self):
        ...
        self.ti_affected[initial_risk] = self.sim.ti + sc.randround(
            self.pars['dur_risk'].rvs(initial_risk) / self.sim.dt)
        return initial_risk
