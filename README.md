...
Typhoidsim implements an agent-based disease model of typhoid fever (caused by S. Typhi). This package is part of the [Starsim](https://github.com/starsimhub) family.
...
4. Typhoidsim from the [main](https://github.com/starsimhub/typhoidsim) branch, which works with [Starsim 3.0](https://pypi.org/project/starsim/) or later.
